package com.mustafabulu.smartpantry.core.log;

public final class LogMessages {

    public static final String VALIDATION_FAILED = "{} Validation failed: {}";
    public static final String EXCEPTION_WITH_MESSAGE = "{} {}";
    public static final String UNEXPECTED_ERROR = "Unexpected error: {}";
    public static final String UNEXPECTED_TRACE = "Unexpected trace: {}";
